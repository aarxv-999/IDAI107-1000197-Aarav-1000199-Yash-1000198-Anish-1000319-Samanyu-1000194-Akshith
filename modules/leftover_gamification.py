"""
Gamification module for the Smart Restaurant Menu Management App.
Handles dynamic cooking quiz generation, XP system, and leaderboard functionality using Firebase and Gemini API.

MADE BY: Enhanced for gamification features with dynamic question generation
"""
